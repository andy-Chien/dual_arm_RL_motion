...
///////////////////////////////////////////////change//////////////////////////////////////////////
  ...
  Eigen::Matrix4d mat_rpy = (mat_pitch*mat_yaw)*mat_roll;
////////////////////////////////////////////////change//////////////////////////////////////////////
  return mat_rpy;
}
...
Eigen::Vector3d convertRotationToRPY(const Eigen::Matrix3d& rotation)
{
  ...
  */
  rpy.coeffRef(2,0) = asin(rotation.coeff(2,1));
  if (rpy.coeffRef(2,0) == M_PI / 2)
  {
      rpy.coeffRef(1,0) = 0;
      rpy.coeffRef(0,0) = atan2(-rotation.coeff(1, 0), -rotation.coeff(1, 1));
  }
  else if (rpy.coeffRef(2,0) == -M_PI / 2)
  {
      rpy.coeffRef(1,0) = 0;
      rpy.coeffRef(0,0) = atan2(-rotation.coeff(1, 0), -rotation.coeff(1, 1));
  }
  ...
  {
      rpy.coeffRef(1,0) = atan2(rotation.coeff(0, 2), -rotation.coeff(2, 2));
      rpy.coeffRef(0,0) = atan2(-rotation.coeff(1, 0), -rotation.coeff(1, 1));
  }
...
Eigen::Matrix3d convertRPYToRotation(double roll, double pitch, double yaw)
{
  ...
  Eigen::Matrix3d rotation = Origin*getRotationY(pitch)*getRotationX(yaw)*getRotationZ(roll);

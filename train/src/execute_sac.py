...
class SAC(object):
    def __init__(self, act_dim, obs_dim, name=None):
        ...
        if self.name == 'right_':
            self.path = '/home/andy/collision_ws/src/Collision_Avoidance/train/weights/'+ NAME +'/'+ self.name+'65'
        else:
            self.path = '/home/andy/collision_ws/src/Collision_Avoidance/train/weights/'+ NAME +'/'+ self.name+'60'
